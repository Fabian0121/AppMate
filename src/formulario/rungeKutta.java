 ...
 * @author Tigre
 */
public class rungeKutta extends javax.swing.JFrame {

    /**
     * Creates new form rungeKutta
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rungeKutta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new rungeKutta().setVisible(true);
            }
        });
    }
